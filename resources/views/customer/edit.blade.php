											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10 fv-row">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="name_customers" class="form-control mb-2" placeholder="name customers" value="{{ $customer->name_customers }}" />
														<!--end::Input-->
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="email" name="email" class="form-control mb-2" placeholder="email" value="{{ $customer->email }}"/>
														<!--end::Input-->
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="number" name="telephone" class="form-control mb-2" placeholder="telephone" value="{{ $customer->telephone }}" />
														<!--end::Input-->
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="address" class="form-control mb-2" placeholder="address" value="{{ $customer->address }}" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
												</div>
